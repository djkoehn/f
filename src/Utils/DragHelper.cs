...
namespace F.Utils
{
    public partial class DragHelper : Node
    {
        ...
        public void StartDrag(BaseBlock block, Vector2 clickPosition)
        {
            ...
            var blockLayerContent = GetTree().Root.GetNodeOrNull<Node2D>(SceneNodeConfig.GameManager.BlockLayer + "/BlockLayerViewport/BlockLayerContent");
            ...
            {
                GD.PrintErr($"[Debug DragHelper] BlockLayerContent not found for block {blockName}, using fallback positioning");
