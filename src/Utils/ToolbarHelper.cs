    ...
    public void ReturnBlockToToolbar(BaseBlock block, Node container)
    {
        ...
        if (container != null)
        {
            ...
            if (connectionManager != null)
            {
                ...
                {
                    GD.Print(
                        $"[ToolbarHelper] Reconnecting {savedSourceBlock.Name ?? "unknown"} to {savedTargetBlock.Name ?? "unknown"}");
                    ...
                    if (newPipe != null)
                    {
                        ...
                        connectionManager.SetConnection(savedSourceBlock, newPipe); // true = is source
            ...
            if (container is ToolbarBlockContainer toolbarContainer)
            {
